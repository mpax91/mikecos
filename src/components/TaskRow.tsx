        ...
        {!isSubtask &&
          (entity.is_recurring ? (
            <span className="last-modified-badge task-row__recurring-badge" title="Generated by a recurring task definition">
              {/* 🔁 alone on mobile, where every bit of row width goes to
                  the title instead — the badge's tinted pill still marks it
                  as "not a timestamp" even without the word spelled out. */}
              {isMobile ? '🔁' : 'Recurring'}
            </span>
          ) : (
