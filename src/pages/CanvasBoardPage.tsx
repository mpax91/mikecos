 ...
 *
 * Deliberately no connector arrows yet (Mike asked for the core canvas
 * first, arrows as a fast-follow) and no multi-select/marquee — v1 is
 * pan/zoom, drag-and-drop images, text/sticky-note items, and single-item
 * drag/resize/delete. */
